...
@interface RNPleasureToRelax () <RCTCxxBridgeDelegate, RCTTurboModuleManagerDelegate> {
...
@implementation RNPleasureToRelax

static RNPleasureToRelax *instance = nil;
